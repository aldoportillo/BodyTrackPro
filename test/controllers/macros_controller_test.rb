...
class MacrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create macro" do
    assert_difference("Macro.count") do
      post macros_url, params: { macro: { added_sugar: @macro.added_sugar, calories: @macro.calories, carb: @macro.carb, fat: @macro.fat, protein: @macro.protein, sugar: @macro.sugar, user_id: @macro.user_id } }
    end
  ...
  test "should update macro" do
    patch macro_url(@macro), params: { macro: { added_sugar: @macro.added_sugar, calories: @macro.calories, carb: @macro.carb, fat: @macro.fat, protein: @macro.protein, sugar: @macro.sugar, user_id: @macro.user_id } }
