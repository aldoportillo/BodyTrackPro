...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { fat_percentage: @metric.fat_percentage, muscle_percentage: @metric.muscle_percentage, user_id: @metric.user_id, weight: @metric.weight } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { fat_percentage: @metric.fat_percentage, muscle_percentage: @metric.muscle_percentage, user_id: @metric.user_id, weight: @metric.weight } }
